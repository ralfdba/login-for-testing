            ...
            if($this->ion_auth->is_admin()){
                ...
                if ($this->form_validation->run() == FALSE){
                    ...
                    if($this->ion_auth->update($this->input->post('id'), $opc)){                        
                        ...
                        $data['message'] = "Exito en la actualizaci&oacute;n del usuario <a href=\"".$this->config->item('url_sistema')."admin/usuarios/index"."\">Volver</a>";
                    }else{
                        $data['message'] = "Error en la actualizaci&0acute;n del usuario. Intente nuevamente <a href=\"".$this->config->item('url_sistema')."admin/usuarios/index"."\">Volver</a>";
                    }
